...
*/
    ...
    pruebas_jugadores.insertar('Insertar jugador', '10945781B','Alberto Dom�nguez',505,'422760421',6,'albdom@gmail.com','11/01/13','albdom',0,'Espa�a',1,true);
    pruebas_jugadores.insertar('Insertar jugador', '10945781C','L�ic Abram',400,'433760422',7,'loicab@gmail.com','12/01/13','loicab',0,'Francia',1,true);
    ...
    pruebas_jugadores.insertar('Insertar jugador', '10045000S','Benjamin Baton',400,'432706413',8,'bejcu@gmail.com','20/01/13','cucufa',0,'Espa�a',3,true);
    ...
    pruebas_jugadores.insertar('Insertar jugador', '20945781G','Nicol�s Dom�nguez',500,'432790427',2,'nicoldom@gmail.com','16/01/13','nicoldom',0,'Bolivia',3,true);
    ...
    pruebas_jugadores.insertar('Insertar jugador', '20945781I','Pablo Galdam�s',300,'432260429',4,'pagal@gmail.com','18/01/13','pagal',0,'Ecuador',2,true);
    pruebas_jugadores.insertar('Insertar jugador', '20945781J','Luciano Orellano',200,'432760323',5,'luciore@gmail.com','19/01/13','luciore',0,'Espa�a',2,true);
    pruebas_jugadores.insertar('Insertar jugador', '20945781K','�ngel Barreal',700,'402160423',6,'angba@gmail.com','20/01/13','angba',0,'Portugal',2,true);
    
    pruebas_jugadores.insertar('Insertar jugador', '20945781L','Lucas Amarilla',800,'630060423',7,'luyellow@gmail.com','21/01/13','luyellow',0,'Espa�a',4,true);
    pruebas_jugadores.insertar('Insertar jugador', '20945781M','Mauricio Romero',400,'462760423',8,'mauro@gmail.com','22/01/13','mauro',0,'M�xico',4,true);
    pruebas_jugadores.insertar('Insertar jugador', '30945781N','Nino Baz�n',600,'432060123',9,'ninobb@gmail.com','23/01/13','ninobb',0,'Espa�a',4,true);
    pruebas_jugadores.insertar('Insertar jugador', '30925000O','Gustavo Gim�nez',300,'462761420',3,'gugi@gmail.com','25/01/13','gugime123',0,'Espa�a',4,true);
    
    pruebas_jugadores.insertar('Insertar jugador', '30915000P','H�ctor de la Fuente',400,'412760410',2,'hecdlf@gmail.com','26/01/13','hectdelafu',0,'Espa�a',5,true);
    pruebas_jugadores.insertar('Insertar jugador', '30940000Q','Tom�s Guidara',500,'432761593',7,'tomgui@gmail.com','27/01/13','tomygui',0,'Espa�a',5,true);
    pruebas_jugadores.insertar('Insertar jugador', '30905000R','Francisco Ortega',500,'497210423',8,'frao@gmail.com','28/01/13','frortegui',0,'Espa�a',5,true);
    pruebas_jugadores.insertar('Insertar jugador', '40935000T','Thiago Almada',200,'121760423',5,'thalm@gmail.com','24/01/13','thalm22',0,'Espa�a',5,true);
    ...
    pruebas_jugadores.insertar('Insertar jugador', '40945781B','Elena Dom�nguez',505,'432767421',6,'elenaitor@gmail.com','11/01/13','elenn',0,'Espa�a',6,true);
    ...
    pruebas_jugadores.insertar('Insertar jugador', '50045000S','Sebasti�n Baton',400,'432709423',8,'sebaselautentico@gmail.com','20/01/13','zebas',0,'Espa�a',7,true);
    ...
    pruebas_jugadores.insertar('Insertar jugador', '50945781G','Juli�n Dom�nguez',500,'431760427',2,'julian123@gmail.com','16/01/13','dominguitomg',0,'Bolivia',7,true);
    ...
    pruebas_jugadores.insertar('Insertar jugador', '50945781I','Juan Galdam�s',300,'232760429',4,'juanol@gmail.com','18/01/13','elrol',0,'Ecuador',8,true);
    pruebas_jugadores.insertar('Insertar jugador', '50945781J','Daniel Orellano',200,'932762323',5,'danielol@gmail.com','19/01/13','dsgpolaris',0,'Espa�a',8,true);
    ...
    pruebas_jugadores.insertar('Insertar jugador', '60945781L','David Amarilla',800,'430160423',7,'davideslol@gmail.com','21/01/13','amarillito',0,'Espa�a',9,true);
    pruebas_jugadores.insertar('Insertar jugador', '60945781M','Juan Romero',400,'402760473',8,'juanmauro@gmail.com','22/01/13','tomillo',0,'M�xico',9,true);
    pruebas_jugadores.insertar('Insertar jugador', '60945781N','Pedro Baz�n',600,'632160423',9,'pedropiedra@gmail.com','23/01/13','pedrinbar',0,'Espa�a',9,true);
    pruebas_jugadores.insertar('Insertar jugador', '60925000O','Antonio Gim�nez',300,'492760420',3,'antoinelal@gmail.com','25/01/13','antoinerelad',0,'Espa�a',9,true);
    
    
    pruebas_jugadores.insertar('Insertar jugador', '60915000P','Santiago de la Fuente',400,'432780400',2,'santitt@gmail.com','26/01/13','santiaguito',0,'Espa�a',9,true);
    pruebas_jugadores.insertar('Insertar jugador', '60940000Q','Tom�s Mu�oz',500,'452761523',7,'tmas@gmail.com','27/01/13','tamastur',0,'Espa�a',10,true);
    pruebas_jugadores.insertar('Insertar jugador', '60905000R','Francisco Heredia',500,'457260423',8,'fracis@gmail.com','28/01/13','erfran999',0,'Espa�a',10,true);
    pruebas_jugadores.insertar('Insertar jugador', '60935000T','Fran Almada',200,'511760423',5,'franchesco@gmail.com','24/01/13','aladilla',0,'Espa�a',8,true);
    ...
    pruebas_jugadores.insertar('Insertar jugador', '60945781B','Mauro Dom�nguez',505,'452760421',6,'maurodomi@gmail.com','11/01/13','marmar',0,'Espa�a',10,true);
    ...
    pruebas_jugadores.insertar('Insertar jugador', '70045000S','�scar Baton',400,'432706723',8,'osquitass@gmail.com','20/01/13','ripper',0,'Espa�a',3,true);
    ...
    pruebas_jugadores.insertar('Insertar jugador', '87094578G','Sara Dom�nguez',500,'462760927',2,'saritalag@gmail.com','16/01/13','sweetlol',0,'Bolivia',4,true);  
    ...
    pruebas_entrenadores.insertar('Insertar entrenador', '21534321E','Jos� Bustos',505,'239180219',6,'joseb@gmail.com','Espa�a',1,true);
    ...
    pruebas_entrenadores.insertar('Insertar entrenador', '98754221I','Jos� Antonio Viera',500,'667180219',1,'josseav@gmail.com','Venezuela',4,true);
    ...
    pruebas_entrenadores.insertar('Insertar entrenador', '65345325L','Juli�n Rubio',300,'630180219',4,'jurub@gmail.com','Ecuador',5,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '57231812M','Luciano Mart�n',200,'640180219',5,'lumart@gmail.com','Espa�a',6,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '94201823N','Antonio Rinc�n',700,'674180219',6,'antcorner@gmail.com','Portugal',6,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '92176392W','Fermin Galeote',800,'601180009',7,'fermga@gmail.com','Espa�a',7,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '62135832O','Paco Gallardo',400,'622180219',8,'pacg@gmail.com','M�xico',7,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '21637524P','Luis Tevenet',600,'792180219',9,'luistv@gmail.com','Espa�a',8,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '79263124Q','Jose Lara',200,'610180219',5,'jlara@gmail.com','Espa�a',8,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '21832138R','�scar Tosato',300,'649180219',3,'oscartos@gmail.com','Espa�a',9,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '72136234S','Carlos Galbis',400,'642180219',2,'carlgal@gmail.com','Espa�a',9,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '37912623T','Fernando Guillam�n',500,'612180219',7,'ferguill@gmail.com','Espa�a',10,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '93218532U','Ram�n Tejada',500,'659180219',8,'ramt@gmail.com','Espa�a',10,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '91234562Z','Santiago Casado',400,'650100210',8,'santicas@gmail.com','Espa�a',3,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '19564321A','Jos� Mu�oz',500,'834387138',5,'joselitox@gmail.com','Francia',11,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '21534321B','Antonio Casado',505,'269180819',6,'antoine@gmail.com','Espa�a',11,true);
    ...
    pruebas_entrenadores.insertar('Insertar entrenador', '78754221F','Maribel Viera',500,'665188219',1,'maribell@gmail.com','Espa�a',14,true);
    ...
    pruebas_entrenadores.insertar('Insertar entrenador', '47231812I','Sara Mart�n',200,'640168219',5,'sarala@gmail.com','Espa�a',6,true);
    ...
    pruebas_entrenadores.insertar('Insertar entrenador', '02176392K','Carlos Galeote',800,'628180009',2,'carlosgal@gmail.com','Espa�a',7,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '62135832L','Pedro Gallardo',400,'618180219',8,'pedrolambo@gmail.com','M�xico',9,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '31637524P','Federico Munez',600,'118180219',4,'lorca@gmail.com','Espa�a',11,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '89263124N','Pedro Lara',200,'610185819',5,'piererelle@gmail.com','Espa�a',12,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '51832138O','Luis Gonz�les',300,'643880219',3,'losluis@gmail.com','Espa�a',13,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '12136234P','Manuel Talmos',400,'642880219',2,'manulel@gmail.com','Espa�a',14,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '97912623Q','Elliot Trump',500,'612182219',1,'trump@gmail.com','Espa�a',10,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '73218532R','Antonio Tejado',500,'658280219',2,'anteh@gmail.com','Espa�a',10,true);
    pruebas_entrenadores.insertar('Insertar entrenador', '11234562S','Santiago Almeida',400,'620180210',2,'sanAlmeida@gmail.com','Espa�a',13,true);
    

   
        /* ======================================================== */
        /*                   INSERCI�N DE OJEADORES                 */
        /* ======================================================== */
     ...
     pruebas_ojeadores.insertar('Insertar ojeador', '62111212G', 'David Gomez', 900, '559836323', 2, 'davidtrainer@gmail.com', 'Espa�a',2 , true);
     pruebas_ojeadores.insertar('Insertar ojeador', '22121212H', 'Mario Alonso', 1300, '663242323', 3, 'marioys@gmail.com', 'Espa�a', 3, true);
     pruebas_ojeadores.insertar('Insertar ojeador', '32121219I', 'Marcos Zid', 1200, '732732323', 3, 'markoss@gmail.com', 'Espa�a', 4, true);
     ...
     pruebas_ojeadores.insertar('Insertar ojeador', '49121212M', 'Bea Mu�oz', 1300, '222252523', 3, 'beatrizgomez@gmail.com', 'Espa�a', 8, true);
     ...
     pruebas_ojeadores.insertar('Insertar ojeador', '12111212F', 'Juli�n Casado', 1200, '482232323', 2, 'juliom@gmail.com', 'Espa�a', 1, true);
     pruebas_ojeadores.insertar('Insertar ojeador', '62121912G', 'Pablo Abascal', 900, '552331323', 2, 'pabloit@gmail.com', 'Espa�a',2 , true);
     pruebas_ojeadores.insertar('Insertar ojeador', '92321212H', 'Maria Vidal', 1300, '660292323', 1, 'mariaAS@gmail.com', 'Espa�a', 3, true);
     pruebas_ojeadores.insertar('Insertar ojeador', '72171212I', 'Alba Rico', 1200, '772538323', 1, 'albamov@gmail.com', 'Espa�a', 4, true);
     ...
     pruebas_ojeadores.insertar('Insertar ojeador', '62221212Z', 'Pedro Martin', 1200, '112432323', 2, 'piere234@gmail.com', 'Espa�a', 7, true);
     pruebas_ojeadores.insertar('Insertar ojeador', '72126212M', 'Laura Ruano', 1300, '222562323', 3, 'lerler@gmail.com', 'Espa�a', 8, true);
     ...
     pruebas_ojeadores.insertar('Insertar ojeador', '52191212G', 'Ignacio Moreno', 900, '559432323', 3, 'igna@gmail.com', 'Espa�a',2 , true);
     pruebas_ojeadores.insertar('Insertar ojeador', '62129212H', 'Maribel Trenado', 1300, '625232323', 1, 'mariii@gmail.com', 'Espa�a', 13, true);
     pruebas_ojeadores.insertar('Insertar ojeador', '22126212I', 'Miguel Rubio', 1200, '773632323', 5, 'mije@gmail.com', 'Espa�a', 4, true);
     ...
     pruebas_ojeadores.insertar('Insertar ojeador', '42171212Z', 'Pedro Abel', 1200, '1123392323', 3, 'iptrieto@gmail.com', 'Espa�a', 7, true);
     pruebas_ojeadores.insertar('Insertar ojeador', '32321212M', '�lvaro Bernal', 1300, '2282272323', 2, 'alvarito697@gmail.com', 'Espa�a', 8, true);
     pruebas_ojeadores.insertar('Insertar ojeador', '92131212O', 'Mat�as Londra', 1100, '124233323', 1, 'matt@gmail.com', 'Alemania', 9, true);
     ...
     pruebas_ojeadores.insertar('Insertar ojeador', '32321212G', 'Pedro Calahorro', 900, '552252323', 1, 'pedrito359@gmail.com', 'Espa�a',12 , true);
     pruebas_ojeadores.insertar('Insertar ojeador', '52121212H', 'Mario Caravaca', 1300, '662939323', 3, 'marioconil@gmail.com', 'Espa�a', 13, true);
     pruebas_ojeadores.insertar('Insertar ojeador', '62131212I', 'Marcos Higuera', 1200, '772222323', 2, 'marcoscasas@gmail.com', 'Espa�a', 14, true);
     ...
     pruebas_ojeadores.insertar('Insertar ojeador', '22127212Z', 'Isabel Hoffman', 1200, '110242323', 3, 'isabella123@gmail.com', 'Espa�a', 7, true);
     pruebas_ojeadores.insertar('Insertar ojeador', '52123212M', 'Bea Martinez', 1300, '222233283', 2, 'beagonzo@gmail.com', 'Espa�a', 8, true);
    ...
    pruebas_partidos.insertar('Insertar partidos',2,2,2,'Hip�dromo','23/12/19 22:13:30,30','Radio',true);
    ...
    pruebas_partidos.insertar('Insertar partidos',8,8,7,'Plaza Espa�a','14/05/19 21:13:30,30','Radio',true);
    ...
    pruebas_partidos.insertar('Insertar partidos',7,7,16,'La Cartuja','04/06/19 15:13:30,30','Televisado',true);
        ...
        /* ======================================================== */
        /*                  INSERCI�N DE ADSCRIPCIONES              */
        /* ======================================================== */


    pruebas_adscripciones.insertar('Insertar adscripci�n','24/01/16','26/01/16','10945781A',1,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','24/01/16',null,'10945781B',1,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','24/01/16',null,'10945781C',1,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','24/01/16',null,'10945781D',1,true);
    
    pruebas_adscripciones.insertar('Insertar adscripci�n','01/05/17',null,'10945781A',11,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','01/05/17',null,'10945781B',11,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','01/05/17',null,'10945781C',11,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','01/05/17',null,'10945781D',11,true);
    
    pruebas_adscripciones.insertar('Insertar adscripci�n','24/11/16',null,'10945781E',2,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','24/11/16',null,'10045000S',2,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','24/11/16',null,'20945781F',2,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','24/11/16',null,'20945781G',2,true);
    
    
    pruebas_adscripciones.insertar('Insertar adscripci�n','10/01/16','12/01/16','2945781H',3,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','14/01/16',null,'20945781I',3,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','14/01/16',null,'20945781J',3,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','14/01/16',null,'20945781K',3,true);
   
    pruebas_adscripciones.insertar('Insertar adscripci�n','30/05/16',null,'20945781L',4,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','30/05/16',null,'20945781M',4,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','30/05/16','02/06/16','30945781N',4,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','30/05/16',null,'30925000O',4,true);
    
    pruebas_adscripciones.insertar('Insertar adscripci�n','10/11/16',null,'30915000P',5,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','10/11/16',null,'30940000Q',5,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','10/11/16',null,'30905000R',5,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','10/11/16',null,'40935000T',5,true);
       
    pruebas_adscripciones.insertar('Insertar adscripci�n','02/02/16',null,'40945781A',6,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','02/02/16',null,'40945781B',6,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','02/02/16',null,'40945781C',6,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','02/02/16',null,'40945781D',6,true);
    
    pruebas_adscripciones.insertar('Insertar adscripci�n','24/04/17',null,'40945781E',7,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','24/04/17',null,'50045000S',7,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','24/04/17',null,'50945781F',7,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','24/04/17',null,'50945781G',7,true);
    
    pruebas_adscripciones.insertar('Insertar adscripci�n','10/05/17',null,'50945781H',8,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','10/05/17',null,'50945781I',8,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','10/05/17',null,'50945781J',8,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','10/05/17',null,'60945781K',8,true);
    
    pruebas_adscripciones.insertar('Insertar adscripci�n','10/01/17',null,'60945781L',9,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','10/01/17',null,'60945781M',9,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','10/01/17',null,'60945781N',9,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','10/01/17',null,'60925000O',9,true);
    
    pruebas_adscripciones.insertar('Insertar adscripci�n','15/02/17',null,'60915000P',10,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','15/02/17',null,'60940000Q',10,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','15/02/17',null,'60905000R',10,true);
    pruebas_adscripciones.insertar('Insertar adscripci�n','15/02/17',null,'60935000T',10,true);

    oid_ad := SEC_OID_AD.currval

        /* ======================================================== */
        /*                 INSERCI�N DE REDES SOCIALES              */
        /* ======================================================== */
    ...
    oid_en := sec_oid_en.currval;
        ...
        /* ======================================================== */
        /*                INSERCI�N DE POSIBLE FICHAJE              */
        /* ======================================================== */

    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Peji123',0,'peji@gmail.com',null,'Espa�a','52123212M',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','JaviCanijo',200,'jcan@gmail.com','Heretics','M�xico','62129212H',true);
    ...
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','KibambabalaXD',450,'kimba@gmail.com','Fnatic','Camer�n','52123212M',true);
    ...
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Caroexpens',240,'caro@gmail.com','G2 Esports','Espa�a','62129212H',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Lassocalss',120,'lasso@gmail.com','CLG','Argentina','49121212M',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Borjita666',160,'borjal@gmail.com','Liquid','Espa�a','62129212H',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','CurritoOMG',400,'curro@gmail.com','Cloud9','Espa�a','52123212M',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','IlloLarita',0,'larita@gmail.com',null,'Espa�a','62129212H',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje', 'Juan777',1,'juanlazar@gmail.com',null,'Espa�a','92127212K',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje', 'Destroyer',0,'desgames@gmail.com',null,'Espa�a','62129212H',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','ElChol',0,'chol@gmail.com',null,'Espa�a','62129212H',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Davidin',200,'davidin@gmail.com','Heretics','M�xico','62129212H',true);
    ...
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','ExplosiveYT',450,'Explosiveee@gmail.com','Fnatic','Camer�n','62129212H',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Leloriso',100,'Leo@gmail.com','Inmortals','Espa�a','32321212M',true);
    ...
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Pensiar',240,'Julianna@gmail.com','G2 Esports','Espa�a','62129212H',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Alcampar',120,'campanar@gmail.com','CLG','Argentina','62129212H',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Raul456',160,'raulero@gmail.com','Liquid','Espa�a','62129212H',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Lisadas',400,'lisa@gmail.com','Cloud9','Espa�a','32321212M',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Personidas',0,'miquell@gmail.com',null,'Espa�a','62129212H',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje', 'LeonorSol',1,'leonores@gmail.com',null,'Espa�a','32321212M',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje', 'BenitoMar',0,'benice@gmail.com',null,'Espa�a','52123212M',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','HierbaBuena',0,'perez@gmail.com',null,'Espa�a','62129212H',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Shooter999',200,'alocao@gmail.com','Heretics','M�xico','92127212K',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Illuminati555',100,'papate�o@gmail.com','EchoFox','Ecuador','62129212H',true);
    ...
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Pepa123',450,'pepaa@gmail.com','Fnatic','Espa�a','52123212M',true);
    ...
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Expertx',240,'lepp@gmail.com','G2 Esports','Espa�a','92127212K',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Lerinasx',120,'leirep@gmail.com','CLG','Argentina','52123212M',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Amoledwera',160,'aromera@gmail.com','Liquid','Espa�a','62129212H',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','Warnatione',400,'peoma@gmail.com','Cloud9','Espa�a','49121212M',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje','DevilBlownw',0,'pilir@gmail.com',null,'Espa�a','62129212H',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje', 'Sweetera',1,'rosaliav@gmail.com',null,'Espa�a','32321212M',true);
    pruebas_posiblesfichajes.insertar('Insertar posible fichaje', 'Soniazz',0,'sonialv@gmail.com',null,'Espa�a','49121212M',true);
    ...
    pruebas_productos.insertar('Insertar producto', 'Chandal club modelo ni�o', 45, 10, 'Ideal para hacer deporte', 'Textil', null, true);
    pruebas_productos.insertar('Insertar producto', 'Camiseta Fortnite', 20, 10, 'Disponible en varios colores', 'Textil', 1, true);
    pruebas_productos.insertar('Insertar producto', 'Raton peque�o', 50, 15, 'No ocupa mucho espacio', 'Electr�nico', null, true);
    pruebas_productos.insertar('Insertar producto', 'Auriculares inal�mbricos', 7, 10, 'Muy buena calidad de audio', 'Electr�nico', null, true);
    pruebas_productos.insertar('Insertar producto', 'Bol�grafos Tetris', 3, 20, 'Disponible en 5 colores', 'Otros', 5, true);
    pruebas_productos.insertar('Insertar producto', 'Teclado RGB', 50, 5, 'Con sonidos especiales de los personajes del Mario Bros', 'Electr�nico', 8, true);
    ...
    pruebas_productos.insertar('Insertar producto', 'Reloj pokemon', 37, 17, 'Posee dibujo de un pokemon aleatorio', 'Electr�nico', 2, true);
    pruebas_productos.insertar('Insertar producto', 'Manta de pelos', 25, 10, 'Ideal para noches fr�as de invierno', 'Textil', null, true);
    pruebas_productos.insertar('Insertar producto', 'Funda m�vil', 15, 30, 'Disponible para varios modelos', 'Otros', null, true);
    pruebas_productos.insertar('Insertar producto', 'Im�n nevera', 2, 100, 'Decora tu nevera', 'Otros', null, true);
    pruebas_productos.insertar('Insertar producto', 'Camiseta LoL', 20, 50, 'El�gela de tu campe�n favorito', 'Textil', 12, true);
    pruebas_productos.insertar('Insertar producto', 'Raton mediano', 15, 10, 'Con hasta 2000dpi', 'Electr�nico', null, true);
    pruebas_productos.insertar('Insertar producto', 'Auriculares con cable', 3, 10, 'Calidad a un precio reduccido', 'Electr�nico', null, true);
    pruebas_productos.insertar('Insertar producto', 'Pegatina LoL', 1, 200, 'Decora tus cuadernos', 'Otros', 12, true);
    pruebas_productos.insertar('Insertar producto', 'Teclado Mec�nico', 150, 10, 'Teclado con cherry mx-Blue', 'Electr�nico', null, true);
    pruebas_productos.insertar('Insertar producto', 'Chandal Logotipo', 75, 35, 'Branding, ideal para clientes', 'Textil', null, true);
    pruebas_productos.insertar('Insertar producto', 'Reloj WoW', 19, 8, 'Digital y totalmente met�lico', 'Electr�nico', 9, true);
    ...
    pruebas_productos.insertar('Insertar producto', 'Luces Led', 45, 20, 'Ilumina tu cuarto', 'Electr�nico', null, true);
    pruebas_productos.insertar('Insertar producto', 'Alfombrilla rat�n', 4, 30, 'Antideslizante y de gran tama�o 16:9', 'Otros', null, true);
    ...
    pruebas_productos.insertar('Insertar producto', 'L�mpara Azul', 19, 10, 'Intensidad ajustable', 'Otros', null, true);
 

        /* ======================================================== */
        /*                  INSERCI�N DE CLIENTE              */
        /* ======================================================== */


    pruebas_clientes.insertar('Insertar cliente', '45263455R', 'Lola', '996867543', 'lolaflores@gmail.com', true);
    pruebas_clientes.insertar('Insertar cliente', '53672388F', 'Ram�n', '356673424', 'ramoncete@hotmail.com', true);
    ...
    pruebas_clientes.insertar('Insertar cliente', '53672388M', 'Mar�a', '446573424', 'meryrdgz@gmail.com', true);
    pruebas_clientes.insertar('Insertar cliente', '67263810L', 'Pablo', '666273426', 'pablito@hotmail.com', true);
    pruebas_clientes.insertar('Insertar cliente', '15243455R', 'Juli�n', '696867543', 'jul@gmail.com', true);
    ...
    pruebas_clientes.insertar('Insertar cliente', '43322388P', 'Mar�a', '6236443424', 'mery123@hotmail.com', true);
    pruebas_clientes.insertar('Insertar cliente', '51242388O', '�scar', '699273424', 'osquita@gmail.com', true);
    ...
    pruebas_clientes.insertar('Insertar cliente', '30045388F', 'Mar�a', '641763114', 'mollym@hotmail.com', true);
    ...
    pruebas_clientes.insertar('Insertar cliente', '23612388M', 'Juli�n', '606373424', 'juliano@gmail.com', true);
    ...
    pruebas_clientes.insertar('Insertar cliente', '23911388F', 'M�nica', '654512423', 'moniquet@hotmail.com', true);
    ...
    pruebas_clientes.insertar('Insertar cliente', '53302388P', 'Pen�lope', '623403404', 'reina@hotmail.com', true);
   ...
   pruebas_pedidos.insertar('Insertar pedido',49,'06/04/2019','40042388F',true);
        ...
        /* ======================================================== */
        /*                INSERCI�N DE LINEAS DE PEDIDOS            */
        /* ======================================================== */
    ...
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',7,'Bol�grafos Tetris',3,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',8,'Funda m�vil',4,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',8,'Funda m�vil',5,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',8,'Funda m�vil',6,true);
    ...
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',7,'Bol�grafos Tetris',13,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',2,'Funda m�vil',15,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',1,'Funda m�vil',16,true);
    ...
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',2,'Funda m�vil',21,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',8,'Chandal Logotipo',22,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',4,'Bol�grafos Tetris',23,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',2,'Alfombrilla rat�n',24,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',3,'Alfombrilla rat�n',25,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',8,'Im�n nevera',26,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',3,'Im�n nevera',27, true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',2,'Im�n nevera',28,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',2,'Im�n nevera',29,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',8,'Im�n nevera',30,true);
    ...
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',8,'Teclado Mec�nico',40,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',2,'Teclado Mec�nico',41,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',3,'Alfombrilla rat�n',42,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',1,'Alfombrilla rat�n',43,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',2,'Alfombrilla rat�n',44,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',3,'Raton peque�o',45,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',2,'Raton peque�o',46,true);
    pruebas_lineasdepedidos.insertar('Insertar lineadepedido',1,'Raton peque�o',47, true);
    ...
    pruebas_usuarios.eliminar('Eliminar usuario', '29584995M', true);
        ...
        /* ======================================================== */
        /*        ACTUALIZACI�N Y ELIMINACI�N DE SEGUIMIENTOS       */
        /* ======================================================== */
